...
export const PlayerCard = ({
  ...
  return (
    <>
      ...
      >
        {/* Card Content Wrapper - Only this gets blurred, not the modal */}
        <div style={{
          width: '100%',
          height: '100%',
          display: 'flex',
          ...
          // Apply blur to the entire card content when color picker is open
              ...
              {capyColors.map((color) => (
                <button
                  ...
                  onClick={(e) => {
                    ...
                    // Close the color picker modal first
                    setShowColorPicker(null);
                    
                    // Then trigger the color change
                  ...
                  onMouseLeave={(e) => {
                    // Only clear hover if modal is still open - prevents clearing during click
                    if (showColorPicker === player.id) {
                      setHoveredColor(null); 
                    }
